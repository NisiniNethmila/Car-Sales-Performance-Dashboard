...
The dashboard enables stakeholders to make data-driven decisions by providing a clear view of key business KPIs and performance metrics.
...
- Monitor commission distribution and profitability
- Improve business reporting and decision-making efficiency
...
- Excel / CSV Dataset (Kaggle source)
...
- Structured dataset for efficient modelling and reporting
...
- **Commission Earned & Maximum Commission** – Calculated performance-based earnings  
- **Profit Analysis** – Evaluated overall dealership profitability  

Advanced DAX techniques applied:
- Iterator functions (SUMX, MAXX)
- Ranking logic (TOPN, RANKX)
- Filter context manipulation
- VALUES-based dynamic calculations
...
- Product-level (car make/model) performance insights
...
- Evaluated commission distribution across sales team
